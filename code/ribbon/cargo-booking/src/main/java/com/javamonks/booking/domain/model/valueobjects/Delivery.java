...
/**
 * Domain class which tracks the progress of the Cargo against the Route
 * Specification / Itinerary and Handling Events.
 */
...
public class Delivery {
	...
	// Current/PRevious information of the Cargo. Helps the operator in determining
