package com.javamonks.booking.application.internal.commandservices;
...
import com.javamonks.booking.application.internal.outboundservices.ExternalCargoRoutingService;
...
public class CargoBookingCommandService {
	...
	public void assignRouteToCargo(RouteCargoCommand routeCargoCommand) {
		 ...
		 * externalCargoRoutingService.fetchRouteForSpecification(new
		 * RouteSpecification( new Location(routeCargoCommand.getOriginLocation()), new
		 * Location(routeCargoCommand.getDestinationLocation()),
