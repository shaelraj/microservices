package com.javamonks.booking.domain.model.commands;
...
public class RouteCargoCommand {
	...
	public RouteCargoCommand(String cargoBookingId, String originLocation, String destinationLocation,
	...
	public void setCargoItinerary(CargoItinerary cargoItinerary) {
		this.cargoItinerary = cargoItinerary;
	}

	public CargoItinerary getCargoItinerary() {
		return this.cargoItinerary;
	}
}
